...
== Current Status
The {iTC-longname} cPP and SD v2.1 documents have been published on November 17, 2025.
...
|Nov 17, 2025
|
|image:Crystal_Clear_mimetype_pdf.png[link=./v2/2.1/cPP_DSC_V2.1.pdf,40,] image:iconfinder_HTML_Logo_65687.png[link=./v2/2.1/cPP_DSC_V2.1.html,40,]
|
|
|
...
|Nov 17, 2025
|
|image:Crystal_Clear_mimetype_pdf.png[link=./v2/2.1/SD_DSC_V2.1.pdf,40,]  image:iconfinder_HTML_Logo_65687.png[link=./v2/2.1/SD_DSC_V2.1.html,40,]
|
|
|
...
|2.1
|November 17, 2025
|image:GitHub-Mark-64px.png[link={iTC-GitHub}/releases/tag/2.1,40,]
...
All previous published versions since v1.0 can be found at {iTC-GitHub}/releases[Releases DSC-iTC/cPP] (this includes all the interim versions up to the publication of v2.1).

== Current Documents for Review
There are currently no documents posted for review.
